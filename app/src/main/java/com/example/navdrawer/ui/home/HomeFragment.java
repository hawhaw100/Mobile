...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Horizontal artist RecyclerView (optional)
        ...
        CustomAdapter adapter = new CustomAdapter(getContext(), titles, imgs, songs);
        binding.lv.setAdapter(adapter);


        NewCustomAdapter adapter2 = new NewCustomAdapter(getContext(), titles, imgs);
        binding.rv.setLayoutManager(
                new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false)
        );
        binding.rv.setAdapter(adapter2);

        // Vertical artist RecyclerView
        ...
        NewCustomAdapter2 adapter3 = new NewCustomAdapter2(getContext(), names, imgs2);
        binding.rv2.setLayoutManager(new LinearLayoutManager(getContext()));
